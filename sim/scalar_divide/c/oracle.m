...
real_part = randi([-32768, 32767], rows, cols) %randi([-32768, 32767], rows, cols); % 16-bit signed integers
imag_part = randi([-32768, 32767], rows, cols) %randi([-32768, 32767], rows, cols);
matrix = complex(real_part, imag_part);

filename = 'matrix.txt'; % Create file name (e.g., row_001.txt)
...
result = matrix ./ 256; %generate quotient
